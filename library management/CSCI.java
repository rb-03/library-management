 ...
 //-------------------------------------CREATE TABLES-------------------------------------------------------------------------//
    ...
    public static void create_book(){
        String d="create table book("
               ...
               + "publish date null,"                               //NEED TO DECLARE NULLLLLLLLLLLLLLLLL AND EDIT IN SAVE BOOK
               + "rating real null,"
    ...
    public static void create_authorship(){
            ...
            String g= "create table authorship("
                      + "callnum char(8),"
                      + "aname char(25),"               //ASKKKKKKKKKKKKKKKKKKKKKKKKK TAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
                      + "foreign key (callnum) references book(callnum),"
